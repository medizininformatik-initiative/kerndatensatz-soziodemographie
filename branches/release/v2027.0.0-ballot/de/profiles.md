# Profiles - MII Implementation Guide Soziodemographie v2027.0.0-ballot.rc1
...
* [MII PR SDD Schulabschluss](StructureDefinition-mii-pr-sdd-schulabschluss.md) - Höchster erreichter allgemeinbildender Schulabschluss (Langversion)
* [MII PR SDD Schuljahre](StructureDefinition-mii-pr-sdd-schuljahre.md) - Anzahl der Jahre, in denen insgesamt eine Schule besucht wurde, inkl. Besuch einer Berufs- oder Hochschule (Minimalversion)
