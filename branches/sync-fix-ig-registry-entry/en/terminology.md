# Terminology - MII Implementation Guide Soziodemographie v2027.0.0-ballot
...
| | |
| :--- | :--- |
| Erstsprache | ISO 639-Sprachcode |
| Geburtsland | ISO 3166-1 Alpha-2 |
| Staatsangehörigkeit | ISO 3166-1 Alpha-2 |
| Geburtsland Mutter | ISO 3166-1 Alpha-2 |
| Geburtsland Vater | ISO 3166-1 Alpha-2 |
| Schulbildung Langversion | Demographische Standards 2024 |
| Ausbildung Langversion | Demographische Standards 2024 |
| Beschäftigungsstatus Langversion | Demographische Standards 2024, angepasst |
| Berufliche Stellung | Demographische Standards 2024 |
| Schulbildung Minimalversion | Anzahl der Schulbesuchsjahre |
| Beschäftigungsstatus Minimalversion | AG-eigene vereinfachte Kodierung |
| Berufliche Stellung Minimalversion | AG-eigene vereinfachte Kodierung |
| Einkommen | Demographische Standards 2024, zusammengefasste Kategorien |
| Erhebungsmethode | AG KDS-Modul Soziodemographische Daten |
| Partnerschaft | AG KDS-Modul Soziodemographische Daten |
| Vertrauensperson | AG KDS-Modul Soziodemographische Daten |
| Betreuungssituation | AG KDS-Modul Soziodemographische Daten |
