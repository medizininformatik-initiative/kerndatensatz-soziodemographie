...
* #1 "Schüler, Auszubildender, Student"
* #2 "nicht berufstätig wegen einer Erkrankung"
* #3 "Rente, Hausfrau/-mann, etc."
* #4 "arbeitssuchend"
* #5 "teilzeitbeschäftigt"
* #6 "vollzeitbeschäftigt"
* #7 "gelegentlich oder unregelmäßig beschäftigt"
